    ...
    return (
        <PageContainer>
            <UserBox>
                ...
                <h2 style={{margin: "0px", width: "500px", padding: "0px"}}><strong style={{fontSize: "32px"}}>{sessionUser.first_name} {sessionUser.last_name}</strong>  |  member since {memberSince()}</h2>
            </UserBox>
            <MainContent>
                <ProfileInfoBox>
                    ...
                    <div className={styles.button} style={{color: "#FC6260"}} id="tab3" onClick={() => onClickMyReservations()}>My Reservations</div>
